...
.pull-left[
From the Tools Bar activate the **Select and transform** tool: ![Select tool](imgs/icons/select_tool.png) or press .key[S] to activate it.
...
.pull-left[
.fr[![Scaling controls](imgs/scale_controls.png)]
...
When grabbing corner controls, rather than locking to square or other preset ratios, .key[Ctrl] maintains the existing ratio.
]
...
.pull-right[
You are dealing with a visually hierarchy of layers.
...
- Home/End: Move to front/back
- Page Up/Down: Move towards front/back
